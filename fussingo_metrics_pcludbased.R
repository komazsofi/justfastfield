...
workingdirectory="O:/Nat_Sustain-proj/_user/ZsofiaKoma_au700510/Justquick_fielddata/fussingo/PointClouds/"
setwd(workingdirectory)

butterflyspfile="O:/Nat_Sustain-proj/_user/ZsofiaKoma_au700510/Justquick_fielddata/fussingo/fussingo_forlidar.shp"

#Import
butterflysp = readOGR(dsn=butterflyspfile)
butterflysp_df=as.data.frame(butterflysp)
