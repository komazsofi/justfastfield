...
for_strat_vegdens=vegdens.rcl+vegdens.rcl
for_strat_NDVI_std_30y=NDVI_std_30y.rcl+NDVI_std_30y.rcl
for_strat_S2_NDVI_p90=S2_NDVI_p90.rcl+S2_NDVI_p90.rcl

prop_samples_vegdens <- ecospat.recstrat_prop(for_strat_vegdens,20)
prop_samples_NDVI_std_30y <- ecospat.recstrat_prop(for_strat_NDVI_std_30y,20)
prop_samples_S2_NDVI_p90 <- ecospat.recstrat_prop(for_strat_S2_NDVI_p90,20)

prop_samples_vegdens_shp=CreateShape(prop_samples_vegdens)
prop_samples_NDVI_std_30y_shp=CreateShape(prop_samples_NDVI_std_30y)
prop_samples_S2_NDVI_p90_shp=CreateShape(prop_samples_S2_NDVI_p90)

# place points

## ecospat combining rasters based on PCA+visual interpret

comb_foropendry=vegdens.rcl+NDVI_std_30y.rcl*10+S2_NDVI_p90.rcl*100
comb_foropendry=NDVI_std_30y.rcl+S2_NDVI_p90.rcl*10
...
shapefile(prop_samples_opendry_shp,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/combined/prop_opendry_level3a.shp")
writeRaster(comb_foropendry,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/combined/comb_foropendry_level3a.tif")

shapefile(prop_samples_vegdens_shp,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/prop_samples_vegdens.shp")
shapefile(prop_samples_NDVI_std_30y_shp,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/prop_samples_NDVI_std_30y.shp")
shapefile(prop_samples_S2_NDVI_p90_shp,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/prop_samples_S2_NDVI_p90.shp")

writeRaster(vegdens.rcl,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/vegdens.tif")
writeRaster(NDVI_std_30y.rcl,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/NDVI_std_30y.tif")
writeRaster(S2_NDVI_p90.rcl,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/simple/S2_NDVI_p90.tif")
