...
FinalRaster_drywet_open=raster("G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/fromZsofia_Stratification/fromZsofia_Stratification/Results/202208week1/Strat_drywet_forest_Level2b.tif")
...
layers_open_dry_c_sel=layers_open_dry_c[[c("forest_qualcomb","forest_treetype","lidar_canopy_height","lidar_vegetation_density","lidar_vegetation_sddsm","lidar_vegetation_stdheight","satelite_S2_NDWI_p90")]]

# make reclassified layers one by one - just to look at it

height.rcl<-ecospat.rcls.grd(layers_open_dry_c_sel[["lidar_canopy_height"]],5)
dens.rcl<-ecospat.rcls.grd(layers_open_dry_c_sel[["lidar_vegetation_density"]],5)
sddsm.rcl<-ecospat.rcls.grd(layers_open_dry_c_sel[["lidar_vegetation_sddsm"]],5)
stdheight.rcl<-ecospat.rcls.grd(layers_open_dry_c_sel[["lidar_vegetation_stdheight"]],5)

rcls=stack(height.rcl,dens.rcl,sddsm.rcl,stdheight.rcl)
...
comb_foropendry=layers_open_dry_c_sel[["forest_qualcomb"]]+height.rcl*10+dens.rcl*100+sddsm.rcl*1000
...
prop_samples_opendry <- ecospat.recstrat_prop(comb_foropendry,20)
prop_samples_opendry_shp=CreateShape(prop_samples_opendry)

# Export

shapefile(prop_samples_opendry_shp,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/combined/prop_samples_openwet.shp")
writeRaster(comb_foropendry,"G:/My Drive/_Aarhus/_PostDoc/Co_Authorproject/Kattrup/Results_20220804/combined/comb_foropenwet.tif")
